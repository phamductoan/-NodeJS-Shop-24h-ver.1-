...
const ProductTypeSchema = require("./app/model/ProductTypeModel");
const ProductSchema = require("./app/model/Product");
const CustomerSchema = require("./app/model/CustomerModel");
const OrderSchema = require("./app/model/OrderModel");
